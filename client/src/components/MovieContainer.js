...
function MovieContainer() {
    ...
    return (
        ...
        <>
            ...
            {
                isLoading ?
                    <div role="status" className="flex h-full w-full justify-center">
                        <svg aria-hidden="true" className="inline w-8 h-8 text-gray-200 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">

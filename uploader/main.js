...
async function getVideoDetails(link, tags) {
    ...
    try {
        ...
        const data = await axios.post(`${process.env.BE_HOST}/api/movies/`, { thumbnail: thumbnail, title: title, link: link, tags: tags}, {headers: {Authorization: `Bearer ${process.env.PLAYLIST_TOKEN}`}})
